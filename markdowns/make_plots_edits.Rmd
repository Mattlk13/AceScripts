...
for (module in ace_by_task) {
  ...
  for (ace_y in valid_ace_ys) {
      generate_plots_and_stats(module_demographs, AGE, ace_y)
      generate_plots_and_stats(module_demographs, GENDER, ace_y)
      generate_plots_and_stats(module_demographs, AGE, ace_y, cohort = GENDER)
  }

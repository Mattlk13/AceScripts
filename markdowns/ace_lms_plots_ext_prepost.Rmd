...
load(file = "~/Documents/ace_large_data/Seacrest Pilot/preproc_data.RData")
```
...
```{r school prefixes}
prefixes = c("br", "pe", "la", "mi", "se", "ca")
schools = c("Bracher", "Peterson", "Laurelwood", "Millenium", "Seacrest", "Cabrillo")
```
